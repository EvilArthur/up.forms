	...
	var FormList = /*#__PURE__*/function () {
	  function FormList() {
	    ...
	    BX.addCustomEvent("onPullEvent", function (module_id, command, params) {
	      if (command === 'update') {
	        ...
	        _this.layout.form = _this.render();
	        _this.loadFormsData();
	      }
	    });
	  ...
	  babelHelpers.createClass(FormList, [{
	    ...
	    value: function renderForm(form) {
	      return main_core.Tag.render(_templateObject3 || (_templateObject3 = babelHelpers.taggedTemplateLiteral(["\n\t\t\t<tr>\n\t\t\t\t<td class=\"align-middle\">", "</td>\n\t\t\t\t<td>", "</td>\n\t\t\t\t<td><a href=\"/form/view/", "/\" class=\"btn btn-success\">", "</a></td>\n\t\t\t\t<td><button class=\"btn btn-info\">", "</button></td>\n\t\t\t\t<td>", "</td>\n\t\t\t</tr>\n\t\t\t"])), form.Title, this.renderOpenConstructorButton(form.ID), form.ID, main_core.Loc.getMessage('UP_FORMS_FORM_LIST_PUBLIC_LINK'), main_core.Loc.getMessage('UP_FORMS_FORM_LIST_PUBLIC_RESULTS'), this.renderDeleteButton(form.ID));
	    }
	  }, {
	    key: "renderOpenConstructorButton",
	    value: function renderOpenConstructorButton(formId) {
	      var _this3 = this;
	      ...
	      main_core.Event.bind(wrap, 'click', function () {
	        _this3.onOpenConstructorButtonClickHandler(formId);
	      });
	      return wrap;
	    }
	  }, {
	    key: "onOpenConstructorButtonClickHandler",
	    value: function onOpenConstructorButtonClickHandler(formId) {
	      BX.SidePanel.Instance.open("/form/edit/".concat(formId, "/"));
	    }
	  }, {
	    ...
	    value: function renderDeleteButton(formId) {
	      ...
	      main_core.Event.bind(wrap, 'click', function () {
	        _this4.onRemoveFormButtonClickHandler(formId);
	      });
	      return wrap;
	    }
	  }, {
