	...
	var FormList = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(FormList, [{
	    ...
	    value: function renderForm(form) {
	      return main_core.Tag.render(_templateObject3 || (_templateObject3 = babelHelpers.taggedTemplateLiteral(["\n\t\t\t<tr>\n\t\t\t\t<td class=\"align-middle\">", "</td>\n\t\t\t\t<td><button class=\"btn btn-primary\">", "</button></td>\n\t\t\t\t<td><button class=\"btn btn-success\">", "</button></td>\n\t\t\t\t<td><button class=\"btn btn-info\">", "</button></td>\n\t\t\t\t<td>", "</td>\n\t\t\t</tr>\n\t\t\t"])), form.Title, main_core.Loc.getMessage('UP_FORMS_FORM_LIST_EDIT'), main_core.Loc.getMessage('UP_FORMS_FORM_LIST_PUBLIC_LINK'), main_core.Loc.getMessage('UP_FORMS_FORM_LIST_PUBLIC_RESULTS'), this.renderDeleteButton(form.ID));
	    }
	  }, {
	    ...
	    value: function renderDeleteButton(formId) {
	      ...
	      main_core.Event.bind(wrap, 'click', function () {
	        _this2.onRemoveFormButtonClickHandler(formId);
	      });
	      return wrap;
	    }
	  }, {
