...
(function (exports,main_core) {
	...
	var Question = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(Question, [{
	    ...
	    key: "renderShortTextInput",
	    value: function renderShortTextInput() {
	      var wrap = main_core.Tag.render(_templateObject2$1 || (_templateObject2$1 = babelHelpers.taggedTemplateLiteral(["\n\t\t\t<input class=\"form-control\" type=\"text\">\n\t\t"])));
	      main_core.Event.bind(wrap, 'change', this.onShortTextInputChangeHandler.bind(this));
	      return wrap;
	    }
	  }, {
	    key: "onShortTextInputChangeHandler",
	    value: function onShortTextInputChangeHandler(event) {
	    ...
	    value: function renderRadios() {
	      ...
	      var wrap = main_core.Tag.render(_templateObject3$1 || (_templateObject3$1 = babelHelpers.taggedTemplateLiteral(["\n\t\t<div class=\"container\">\n\t\t\t", "\n\t\t\t", "\n\t\t</div>"])), this.options.map(function (option) {
	        return _this.renderRadio(option.ID, option.Value);
	      }), this.renderClearRadioButton());
	      (_this$layout$input = this.layout.input) === null || _this$layout$input === void 0 ? void 0 : _this$layout$input.replaceWith(wrap);
	      this.layout.input = wrap;
	      return this.layout.input;
	    }
	  }, {
	    key: "renderRadio",
	    value: function renderRadio(id, value) {
	      var wrap = main_core.Tag.render(_templateObject4$1 || (_templateObject4$1 = babelHelpers.taggedTemplateLiteral(["\n\t\t\t<div class=\"form-check\">\n\t\t\t\t<input class=\"form-check-input\" type=\"radio\" name=\"", "_", "\" value=\"", "\">\n\t\t\t\t<label class=\"form-check-label\">", "</label>\n\t\t\t</div>\n\t\t"])), this.title, this.id, id, value);
	      main_core.Event.bind(wrap, 'change', this.onRadioChangeHandler.bind(this));
	      return wrap;
	    }
	  }, {
	    key: "onRadioChangeHandler",
	    value: function onRadioChangeHandler(event) {
	      this.selectedValue = event.target.value;
	    }
	  }, {
