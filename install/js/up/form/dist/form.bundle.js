...
(function (exports,main_core) {
	...
	var _templateObject$5, _templateObject2$2, _templateObject3$2, _templateObject4$1, _templateObject5$1, _templateObject6;
	...
	var Form = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(Form, [{
	    ...
	    value: function renderTimer() {
	      if (this.timer) {
	        var wrap = main_core.Tag.render(_templateObject5$1 || (_templateObject5$1 = babelHelpers.taggedTemplateLiteral(["<div class=\"container text-center mt-4\">\n\t\t\t\t\t\t\t\t\t\t<div id=\"timer\" class=\"display-6\">", "</div>\n\t\t\t\t\t\t\t\t\t</div>"])), this.renderTime());
	        return wrap;
	      } else {
	        return '';
	      }
	    ...
	    value: function renderTime() {
	      var wrap = main_core.Tag.render(_templateObject6 || (_templateObject6 = babelHelpers.taggedTemplateLiteral(["<p></p>"])));
