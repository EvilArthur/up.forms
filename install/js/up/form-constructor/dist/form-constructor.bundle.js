...
(function (exports,main_core) {
	...
	var Constructor = /*#__PURE__*/function () {
	  function Constructor(formData, fieldData) {
	    ...
	    formData.CHAPTER[0].QUESTION.map(function (questionData) {
	      var question = new Question(questionData.CHAPTER_ID, questionData.FIELD_ID, questionData.ID, questionData.POSITION, questionData.TITLE, questionData.OPTION, fieldData);
	  ...
	  babelHelpers.createClass(Constructor, [{
	    ...
	    value: function renderQuestionList() {
	      ...
	      var wrap = main_core.Tag.render(_templateObject2$2 || (_templateObject2$2 = babelHelpers.taggedTemplateLiteral(["\n\t\t<div class=\"container\">\n\t\t\t", "\n\t\t</div>\n\t\t"])), this.questions.map(function (question) {
	...
	var Setting = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(Setting, [{
	    key: "render",
	    value: function render() {
	      var wrap = main_core.Tag.render(_templateObject$4 || (_templateObject$4 = babelHelpers.taggedTemplateLiteral(["<div class=\"mb-3\">\n\t\t\t\t\t\t\t\t\t<label class=\"form-label\">", "</label>\n\t\t\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t\t\t</div>"])), this.title, this.renderBindedInput());
	      return wrap;
	    }
	  }, {
	    key: "renderInput",
	...
	var Checkbox = /*#__PURE__*/function (_Setting) {
	...
	var Settings = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(Settings, [{
	    ...
	    value: function renderSettingList() {
	      var wrap = main_core.Tag.render(_templateObject2$3 || (_templateObject2$3 = babelHelpers.taggedTemplateLiteral(["<div>\n\t\t\t", "\n\t\t</div>"])), this.settings.map(function (setting) {
	...
	var _templateObject$a, _templateObject2$4, _templateObject3$3, _templateObject4$3, _templateObject5$2, _templateObject6$1, _templateObject7$1;
	...
	var FormConstructor = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(FormConstructor, [{
	    ...
	    value: function render() {
	      ...
	      var wrap;
	      if (this.isLoading) {
	        wrap = main_core.Tag.render(_templateObject$a || (_templateObject$a = babelHelpers.taggedTemplateLiteral(["\n\t\t\t<div class=\"container d-flex justify-content-center\">\n\t\t\t\t<div class=\"spinner-border\" style=\"width: 3rem; height: 3rem;\" role=\"status\">\n\t\t\t\t\t<span class=\"sr-only\"></span>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t"])));
	      } else {
	        ...
	        wrap = main_core.Tag.render(_templateObject2$4 || (_templateObject2$4 = babelHelpers.taggedTemplateLiteral(["<div></div>"])));
