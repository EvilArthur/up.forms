	...
	public static function getMap()
	{
		return [
			(new IntegerField('FORM_ID',
							  []
			))->configureTitle(Loc::getMessage('FORM_SETTINGS_ENTITY_FORM_ID_FIELD'))
			  ->configurePrimary(true),
			(new IntegerField('SETTINGS_ID',
							  []
			))->configureTitle(Loc::getMessage('FORM_SETTINGS_ENTITY_SETTINGS_ID_FIELD'))
			  ->configurePrimary(true),
			(new StringField('VALUE',
							 [
								 'validation' => [__CLASS__, 'validateValue']
							 ]
			))->configureTitle(Loc::getMessage('FORM_SETTINGS_ENTITY_VALUE_FIELD')),
